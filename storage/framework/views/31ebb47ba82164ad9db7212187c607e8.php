...
<header x-data="{ mobileMenuOpen: false, dropdownOpen: false }" class="border-b border-zinc-200 dark:border-zinc-800 bg-white/80 dark:bg-zinc-950/80 backdrop-blur-md sticky top-0 z-50 transition-colors">
            ...
            <div class="flex items-center gap-8">
                ...
                <a href="/" class="flex items-center gap-3 hover:opacity-95 transition-opacity group">
                    <div class="relative flex items-center justify-center transition-all duration-300">
                        <img src="<?php echo e(asset('logo.png')); ?>" alt="Logo" class="dark:hidden relative w-14 h-14 md:w-16 md:h-16 object-contain z-10 transition-transform duration-300 group-hover:scale-105">
                        <img src="<?php echo e(asset('logob.png')); ?>" alt="Logo" class="hidden dark:block relative w-14 h-14 md:w-16 md:h-16 object-contain z-10 transition-transform duration-300 group-hover:scale-105">
                    </div>
                ...
                <nav class="hidden md:flex items-center gap-1.5 border-l border-zinc-200 dark:border-zinc-800 pl-6 h-8">
                    <a href="/" class="text-sm font-semibold px-3 py-1.5 rounded-lg transition-colors <?php echo e($activeMenu == 'dashboard' ? 'text-red-600 dark:text-red-400 bg-red-50 dark:bg-red-500/10 shadow-sm' : 'text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-200'); ?>">
                        Dashboard
                    </a>
                    <a href="/tickets" class="text-sm font-semibold px-3 py-1.5 rounded-lg transition-colors <?php echo e($activeMenu == 'tickets' ? 'text-red-600 dark:text-red-400 bg-red-50 dark:bg-red-500/10 shadow-sm' : 'text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-200'); ?>">
                        Tiket
                    </a>
                    <?php if(auth()->check() && (auth()->user()->hasRole('admin') || auth()->user()->hasRole('dest_manager'))): ?>
                        <a href="/users" class="text-sm font-semibold px-3 py-1.5 rounded-lg transition-colors <?php echo e($activeMenu == 'users' ? 'text-red-600 dark:text-red-400 bg-red-50 dark:bg-red-500/10 shadow-sm' : 'text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-200'); ?>">
                            Pengguna
                        </a>
        ...
        <div x-show="mobileMenuOpen" 
            ...
            <nav class="flex flex-col gap-1">
                <a href="/" class="text-sm font-semibold px-4 py-2.5 rounded-xl transition-colors <?php echo e($activeMenu == 'dashboard' ? 'text-red-600 dark:text-red-400 bg-red-50 dark:bg-red-500/10' : 'text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-200'); ?>">
                    Dashboard
                </a>
                <a href="/tickets" class="text-sm font-semibold px-4 py-2.5 rounded-xl transition-colors <?php echo e($activeMenu == 'tickets' ? 'text-red-600 dark:text-red-400 bg-red-50 dark:bg-red-500/10' : 'text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-200'); ?>">
                    Tiket
                </a>
                <?php if(auth()->check() && (auth()->user()->hasRole('admin') || auth()->user()->hasRole('dest_manager'))): ?>
                    <a href="/users" class="text-sm font-semibold px-4 py-2.5 rounded-xl transition-colors <?php echo e($activeMenu == 'users' ? 'text-red-600 dark:text-red-400 bg-red-50 dark:bg-red-500/10' : 'text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-200'); ?>">
                        Pengguna
                    </a>
    ...
    </header><?php /**PATH /app/resources/views/layouts/header.blade.php ENDPATH**/ ?>