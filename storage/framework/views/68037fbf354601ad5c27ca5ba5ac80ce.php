    ...
    <div class="w-full max-w-md flex flex-col gap-6 my-auto">
        ...
        <div class="flex flex-col items-center gap-2 text-center">
            <div class="relative flex items-center justify-center transition-all duration-300 group">
                <img src="<?php echo e(asset('logo.png')); ?>" alt="Logo" class="dark:hidden relative w-28 h-28 md:w-32 md:h-32 object-contain z-10 transition-transform duration-300 group-hover:scale-105">
                <img src="<?php echo e(asset('logob.png')); ?>" alt="Logo" class="hidden dark:block relative w-28 h-28 md:w-32 md:h-32 object-contain z-10 transition-transform duration-300 group-hover:scale-105">
            </div>
